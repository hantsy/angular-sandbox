...
export declare const buildConfiguration: (defaultConfigResolver: DefaultConfigResolver, customConfigResolver: CustomConfigResolver) => (projectRoot: Path, workspaceRoot: Path, configPath?: string) => any;
export declare class JestConfigurationBuilder {
    ...
    buildConfiguration(projectRoot: Path, workspaceRoot: Path, configPath?: string): any;
}
