...
function getRoots(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const workspace = yield core_1.experimental.workspace.Workspace.fromPath(host, core_1.normalize(context.workspaceRoot), registry);
...
function runJest(options, context) {
    ...
    function buildArgv() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const configuration = new jest_configuration_builder_1.JestConfigurationBuilder(new default_config_resolver_1.DefaultConfigResolver(), new custom_config_resolver_1.CustomConfigResolver(context.logger.createChild('Jest runner')))
